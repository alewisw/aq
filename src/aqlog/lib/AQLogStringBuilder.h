...
public:
     ...
     * character was not found.
     */
    iterator find(const iterator& pos, char ch) const;
     ...
     * string or end() if the string was not found.
     */
    iterator find(const iterator& pos, const std::string& str) const
    {
     ...
     * string or end() if the string was not found.
     */
    iterator find(const iterator& pos, const char *str) const;
